$(document).ready(function(){
	...
	if ($('#weather-widget-1').length > 0){
		$("#weather-widget-1").backstretch("/img/admin/img/photo/medium/img-12.jpg");
	}
	if ($('#weather-widget-2').length > 0){
		$("#weather-widget-2").backstretch("/img/admin/img/photo/medium/img-13.jpg");
	}
	if ($('#search-heading').length > 0){
		$("#search-heading").backstretch("/img/admin/img/photo/medium/img-12.jpg");
	}
	if ($('#property-search-wrap').length > 0){
		$("#property-search-wrap").backstretch("/img/admin/img/photo/medium/img-19.jpg");
	}
	/** END BACK STRETCH **/
